import {createApp, h, hFragment} from "https://unpkg.com/ox1s-fe-fwk@1.0.2";
...
const state = {
    ...
    todos: ['Learn Angular', 'Learn React', 'Learn Vue'],
}
...
function TodoItem({todo, i, edit}, emit) {
    ...
    return isEditing
        ? h('li', {}, [
            ...
            h('button', {on: {click: () => emit('cancel-editing-todo')}}, ['Cancel'])
        ])
        : h('li', {}, [
